...
main(int argc,char *argv[]) {
  ...
  1a:	232080e7          	jalr	562(ra) # 248 <atoi>
  1e:	892a                	mv	s2,a0
    int returnCode = fork();
  20:	00000097          	auipc	ra,0x0
  24:	31c080e7          	jalr	796(ra) # 33c <fork>
    if(returnCode < 0) {
  28:	04054963          	bltz	a0,7a <main+0x7a>
        printf("Error in forking\n");
        exit(0);
    }
    else if(returnCode == 0) {
  2c:	c525                	beqz	a0,94 <main+0x94>
        exec(argv[2],&argv[2]);
  ...
  34:	31c080e7          	jalr	796(ra) # 34c <wait>
        getSysCount(mask);
  38:	854a                	mv	a0,s2
  3a:	00000097          	auipc	ra,0x0
  3e:	3b2080e7          	jalr	946(ra) # 3ec <getSysCount>
    }
    return 0;
  42:	4501                	li	a0,0
  44:	60e2                	ld	ra,24(sp)
  ...
  54:	84050513          	addi	a0,a0,-1984 # 890 <malloc+0xee>
  58:	00000097          	auipc	ra,0x0
  5c:	68c080e7          	jalr	1676(ra) # 6e4 <printf>
        printf("The input format is : syscount <mask> <command> [args....]\n");
  60:	00001517          	auipc	a0,0x1
  64:	85050513          	addi	a0,a0,-1968 # 8b0 <malloc+0x10e>
  68:	00000097          	auipc	ra,0x0
  6c:	67c080e7          	jalr	1660(ra) # 6e4 <printf>
        exit(0);
  70:	4501                	li	a0,0
  72:	00000097          	auipc	ra,0x0
  76:	2d2080e7          	jalr	722(ra) # 344 <exit>
        printf("Error in forking\n");
  7a:	00001517          	auipc	a0,0x1
  7e:	87650513          	addi	a0,a0,-1930 # 8f0 <malloc+0x14e>
  82:	00000097          	auipc	ra,0x0
  86:	662080e7          	jalr	1634(ra) # 6e4 <printf>
        exit(0);
  8a:	4501                	li	a0,0
  8c:	00000097          	auipc	ra,0x0
  90:	2b8080e7          	jalr	696(ra) # 344 <exit>
        exec(argv[2],&argv[2]);
  94:	01048593          	addi	a1,s1,16
  98:	6888                	ld	a0,16(s1)
  9a:	00000097          	auipc	ra,0x0
  9e:	2e2080e7          	jalr	738(ra) # 37c <exec>
        printf("Error in exec\n");
  a2:	00001517          	auipc	a0,0x1
  a6:	86650513          	addi	a0,a0,-1946 # 908 <malloc+0x166>
  aa:	00000097          	auipc	ra,0x0
  ae:	63a080e7          	jalr	1594(ra) # 6e4 <printf>
        exit(0);
  b2:	4501                	li	a0,0
  b4:	00000097          	auipc	ra,0x0
  b8:	290080e7          	jalr	656(ra) # 344 <exit>
...
_main()
{
  ...
  d2:	276080e7          	jalr	630(ra) # 344 <exit>
...
gets(char *buf, int max)
{
 ...
 1c4:	19c080e7          	jalr	412(ra) # 35c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 216:	172080e7          	jalr	370(ra) # 384 <open>
  if(fd < 0)
 ...
 226:	17a080e7          	jalr	378(ra) # 39c <fstat>
 22a:	892a                	mv	s2,a0
  close(fd);
 22c:	8526                	mv	a0,s1
 22e:	00000097          	auipc	ra,0x0
 232:	13e080e7          	jalr	318(ra) # 36c <close>
  return r;
}
 236:	854a                	mv	a0,s2
...
memcpy(void *dst, const void *src, uint n)
{
 ...
 330:	f66080e7          	jalr	-154(ra) # 292 <memmove>
}
 334:	60a2                	ld	ra,8(sp)
 336:	6402                	ld	s0,0(sp)
